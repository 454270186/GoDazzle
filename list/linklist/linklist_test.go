...
func benchmarkAdd(l *linklist.Linklist, size int, b *testing.B) {
	for i := 0; i < b.N; i++ {
		for j := 0; j < size; j++ {
			l.Add(j)
		}
...
func benchmarkGet(l *linklist.Linklist, size int, b *testing.B) {
	for i := 0; i < b.N; i++ {
		for j := 0; j < size; j++ {
			l.Get(j)
		}
...
func benchmarkRemove(l *linklist.Linklist, size int, b *testing.B) {
	for i := 0; i < b.N; i++ {
		for j := 0; j < size; j++ {
			l.Remove(j)
		}
